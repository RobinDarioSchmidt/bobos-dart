...
export function PlayerRivalryDialog({
  ...
  return (
    <div
      className="fixed inset-0 z-[120] flex items-start justify-center overflow-y-auto bg-black/65 p-3 sm:p-6"
      onClick={onClose}
    >
      <div
        className="max-h-[calc(100vh-1rem)] w-full max-w-2xl overflow-y-auto rounded-[1.75rem] border border-white/10 bg-[#0f172a] p-4 shadow-2xl shadow-black/40 sm:max-h-[calc(100vh-3rem)]"

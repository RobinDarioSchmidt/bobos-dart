        ...
        <div className="space-y-5">
          ...
          <div className="space-y-3">
            <h1 className="max-w-3xl text-4xl font-semibold tracking-tight text-white sm:text-5xl">
              Darts fuer Zuhause, Training und Online-Matches in einer klaren App.
            </h1>
            <p className="max-w-2xl text-sm leading-6 text-stone-300 sm:text-base">
              ...
              online einen Raum oeffnen, trainieren oder direkt in deine Langzeitstatistiken gehen willst.
            </p>
          </div>
      ...
      <div className="space-y-6 p-6 lg:p-8">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-6 text-stone-300 sm:text-base">
                Waehle deinen Modus und starte direkt in lokales Spiel, Online-Raum, Training oder Profil.
              </p>
            </div>
          </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          >
            ...
            <p className="mt-2 text-sm text-stone-300">
              Live gegen Freunde spielen, synchronisiert ueber eure Konten.
            </p>
          </Link>
        ...
        <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="rounded-[1.5rem] border border-white/10 bg-black/20 p-4">
            <p className="text-xs uppercase tracking-[0.24em] text-stone-400">Cloud Uebersicht</p>
            {cloudStats ? (
